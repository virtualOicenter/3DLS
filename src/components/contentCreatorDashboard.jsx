...
function ContentCreatorDashBoard() {
    ...
    return (
        <div className='contentCreatorDashboard flex flex-column align-items-center w-12'
            style={{ direction: 'rtl' }}>
            <Toast ref={toast} />
        <div className='contentCreatorDashboard flex flex-column align-items-center w-12'
            style={{ direction: 'rtl' }}>
            <span className='flex flex-column vertical-align-baseline w-9'>
                ...
                <div className='flex flex-row justify-content-center align-items-center w-auto gap-3 mx-5'>
                    ...
                    <InputText className='w-full h-2rem' value={filterString} onChange={(e)=> {setFilterString(e.target.value)}} />
